...
This is **the single remaining native-install risk for `npx deflow up`** (NF6). Upstream
...
| S6    | Does `@lydell/node-pty` cover the platform matrix?             | S, 0.5 d | ACP `terminal/*`, `npx deflow up` |
